...
if __name__ == '__main__':
    ...
    for q_idx in range(0, 30):
        ...
        for t in range(1, 30):
            ...
            query_indices = visualizer.vis_rank_list_video(q_idx, t, 0.4, args.output, args.vis_label, args.num_vis,
                                                    args.rank_sort, args.label_sort, max_cam=6, g_indices=g_indices, rank=args.rank)
        ...
        vidout = cv2.VideoWriter('out_query_%02d_rank_%d.avi' % (q_idx, args.rank), cv2.VideoWriter_fourcc(*'DIVX'), 20, (w, h))
