...
@torch.no_grad()
def build_dist(feat_1: torch.Tensor, feat_2: torch.Tensor, metric: str = "euclidean", original_dist=None, **kwargs):
    ...
    if metric == "euclidean":
        ...
        dist = compute_jaccard_distance(feat, k1=kwargs["k1"], k2=kwargs["k2"], search_option=3, original_dist=original_dist)
...
@torch.no_grad()
def compute_jaccard_distance(features, k1=20, k2=6, search_option=0, fp16=False, original_dist=None):
    if search_option < 3:
    ...
    if search_option == 0:
        ...
        # print('hi', initial_rank.shape) # (19281, 20)
