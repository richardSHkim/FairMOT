...
class MTADemo(ImageDataset):
    ...
    def __init__(self, root='datasets', market1501_500k=False, **kwargs):
        ...
        self.query_dir = osp.join(self.data_dir, 'query_demo_filtered')
        self.gallery_dir = osp.join(self.data_dir, 'test_gallery_demo_filtered')
        ...
        super(MTADemo, self).__init__(train, query, gallery, **kwargs)
