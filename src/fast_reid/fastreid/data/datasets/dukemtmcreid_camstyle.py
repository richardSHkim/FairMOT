...
class DukeMTMCCamStyle(ImageDataset):
    """DukeMTMC-reID CamStyle.
    ...
    dataset_name = "dukemtmc_camstyle"

    def __init__(self, root='datasets', **kwargs):
        # self.root = osp.abspath(osp.expanduser(root))
        self.root = root
        self.dataset_dir = osp.join(self.root, self.dataset_dir)
        self.train_dir = osp.join(self.dataset_dir, 'bounding_box_train_camstyle')
        ...
        super(DukeMTMCCamStyle, self).__init__(train, query, gallery, **kwargs)
    ...
    def process_dir(self, dir_path, is_train=True):
        ...
        for img_path in img_paths:
            ...
            frame = int(img_name.strip().split('_')[2][1:-4])
