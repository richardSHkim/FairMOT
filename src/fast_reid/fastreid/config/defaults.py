...
_C.MODEL.LOSSES.CE.CAMSTYLE_SCALE = 1.0
...
_C.MODEL.WEIGHTS = "fast_reid/logs/mta/agw_R50/model_final.pth"
...
# Enable training with camstyle images
_C.DATASETS.CAMSTYLE = False
_C.DATASETS.HALFBATCH = False
...
# Spatial-Temporal
_C.TEST.SPATIALTEMPORAL = CN()
_C.TEST.SPATIALTEMPORAL.ALPHA = 5
_C.TEST.SPATIALTEMPORAL.SMOOTH = 50
